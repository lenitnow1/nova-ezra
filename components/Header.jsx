...
export default function Header({ headerRef }) {
  ...
  const menuItems = [
    ...
    { label: 'Features', ariaLabel: 'View features', link: '/learn-more' },
    { label: 'Reading Room', ariaLabel: 'Open dashboard', link: '/dashboard' },
    { label: 'About', ariaLabel: 'About page', link: '/learn-more' }
  ]
  ...
  return (
    <header ref={headerRef} className="relative z-50 border-b border-gold/10">

      {/* STAGGERED MENU (mobile + overlay nav) */}
            ...
            <>
              <SignedOut>
                <SignInButton mode="modal">
                  <button
                    type="button"
                    className="btn-embossed text-sm py-2 px-4"
                  >
                    Sign In
                  </button>
                </SignInButton>
